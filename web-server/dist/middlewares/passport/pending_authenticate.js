...
/**
 * `AuthenticationError` error. Inherit from `Error`.
 *
 * @api private
 */
        ...
        return new Promise((resolve, reject) => {
            ...
            function allFailed() {
                ...
                if (options.failWithError) {
                    return reject(new AuthenticationError(http.STATUS_CODES[res.statusCode], rstatus));
                }
                ...
                strategy.success = (user, info = {}) => {
                    ...
                    req.logIn(user, options, (err) => {
                        ...
                        if (options.authInfo !== false) {
                            passport.transformAuthInfo(info, req, (deeperErr, tinfo) => {
                                if (err) {
                                    return reject(deeperErr);
                                }
                                req.authInfo = tinfo;
                                complete();
                            });
...
//# sourceMappingURL=pending_authenticate.js.map
